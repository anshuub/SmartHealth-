...
class _UserSignupPageState extends State<UserSignupPage> {
  ...
  Future<void> _sendDataToBackend(
    ...
    final uri = Uri.parse('http://192.168.3.128:5000/signin');
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              // Phone Field
              _buildTextField(_phoneController, 'Phone No.', inputType: TextInputType.phone),
              const SizedBox(height: 10),
              ...
              Row(
                children: [
                  ...
                  if (_voiceRecorded) const Icon(Icons.check, color: Colors.green),
                ],
              ),
              const SizedBox(height: 20),
              ...
              _isLoading
                  ...
                  : ElevatedButton(
                      onPressed: _signUp,
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.teal, // Background color property
  ...
  Widget _buildTextField(TextEditingController controller, String label, {TextInputType inputType = TextInputType.text, bool obscureText = false}) {
